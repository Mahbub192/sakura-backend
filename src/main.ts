...
async function bootstrap() {
  ...
  // Skip database existence check in production - database should already exist
  // Only check in development mode
  if (!isProduction) {
    await ensureDatabaseExists();
  } else {
    console.log('✅ Production mode - skipping database existence check');
    console.log('   Database should already exist in cPanel');
  }
